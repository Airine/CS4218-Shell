...
public class CallCommand_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, CallCommand_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.OutputStream", false, CallCommand_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("sg.edu.nus.comp.cs4218.impl.util.ApplicationRunner", false, CallCommand_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("sg.edu.nus.comp.cs4218.impl.util.ArgumentResolver", false, CallCommand_ESTest_scaffolding.class.getClassLoader()));
  }
